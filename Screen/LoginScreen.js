...
const LoginScreen = ({ onLogin, navigation }) => {
    ...
    return (<react_native_1.View style={styles.container}>
      <react_native_1.ImageBackground source={ScreenBG_png_1.default} style={styles.background}>
        <react_native_1.View style={styles.loginWrap}>
          <react_native_1.TouchableWithoutFeedback onPress={keyboardHide}>
            <react_native_1.KeyboardAvoidingView behavior={react_native_1.Platform.OS === "ios" ? "padding" : "height"} style={styles.keyboardAvoidingContainer}>
              <react_native_1.Text style={styles.title}>Увійти</react_native_1.Text>
              <react_native_1.View style={styles.inputContainer}>
                ...
                <react_native_1.View style={styles.passwordContainer}>
                  <react_native_1.TextInput value={state.password} onChangeText={passwordHandler} placeholder="•••••••••••••••" secureTextEntry={!showPassword} style={styles.passwordInput} onFocus={() => {
            ...
            setIsShowKeyboard(false);
                  ...
                  <react_native_1.TouchableWithoutFeedback onPress={toggleShowPassword}>
                    <react_native_1.Text style={styles.toggleText}>
                      {showPassword ? "Сховати" : "Показати"}
                    </react_native_1.Text>
                  </react_native_1.TouchableWithoutFeedback>
                </react_native_1.View>
                <react_native_1.TouchableWithoutFeedback onPress={handleSubmit}>
                  <react_native_1.View style={styles.buttonRg}>
                    <react_native_1.Text style={styles.buttonText}>Увійти</react_native_1.Text>
                  </react_native_1.View>
                </react_native_1.TouchableWithoutFeedback>
