...
function App() {
  ...
  var isRegistered = _a[0];
  var setIsRegistered = _a[1];
  ...
  return react_1.default.createElement(
    ...
    null,
    isLogin
      ? react_1.default.createElement(LoginScreen_1.default, {
          onLogin: handleLogin,
        })
      : react_1.default.createElement(RegistrationScreen_1.default, {
